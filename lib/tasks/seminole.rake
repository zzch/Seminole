  ...
  task populate: :environment do
    ...
    bench = Benchmark.measure do
      ...
      Club.last.tap do |club|
        ...
        club.cards.create!([
          { type: :by_time, name: '6800元 计时卡', background_color: Faker::Number.hexadecimal(6), price: 6800.00, total_amount: 10000, valid_months: 12, maximum_vacancies: 2, minute_amount: 6000, minimum_charging_minutes: 20, unit_charging_minutes: 60, maximum_discard_minutes: 20 },
          { type: :by_time, name: '12000元 计时卡', background_color: Faker::Number.hexadecimal(6), price: 12000.00, total_amount: 10000, valid_months: 24, maximum_vacancies: 3, minute_amount: 12000, minimum_charging_minutes: 20, unit_charging_minutes: 60, maximum_discard_minutes: 20 },
          { type: :by_ball, name: '9800元 计球卡', background_color: Faker::Number.hexadecimal(6), price: 9800.00, total_amount: 10000, valid_months: 12, maximum_vacancies: 2, ball_amount: 10000 },
          { type: :by_ball, name: '15800元 计球卡', background_color: Faker::Number.hexadecimal(6), price: 15800.00, total_amount: 10000, valid_months: 24, maximum_vacancies: 3, ball_amount: 20000 },
          { type: :stored, name: '49800元 储值卡', background_color: Faker::Number.hexadecimal(6), price: 45800.00, total_amount: 2000, valid_months: 36, maximum_vacancies: 5, price_per_hour: 100, price_per_ball: 0.5, minimum_charging_minutes: 20, unit_charging_minutes: 60, maximum_discard_minutes: 20 }
        ])
        100.times do
      ...
      Club.first.tap do |club|
        ...
        club.cards.create!([
          { type: :by_time, name: '5990元 计时卡', background_color: Faker::Number.hexadecimal(6), price: 5990.00, total_amount: 10000, valid_months: 12, maximum_vacancies: 2, minute_amount: 6000, minimum_charging_minutes: 20, unit_charging_minutes: 60, maximum_discard_minutes: 20 },
          { type: :by_time, name: '12990元 计时卡', background_color: Faker::Number.hexadecimal(6), price: 12990.00, total_amount: 10000, valid_months: 24, maximum_vacancies: 3, minute_amount: 12000, minimum_charging_minutes: 20, unit_charging_minutes: 60, maximum_discard_minutes: 20 },
          { type: :by_ball, name: '9990元 计球卡', background_color: Faker::Number.hexadecimal(6), price: 9990.00, total_amount: 10000, valid_months: 12, maximum_vacancies: 2, ball_amount: 10000 },
          { type: :by_ball, name: '15990元 计球卡', background_color: Faker::Number.hexadecimal(6), price: 15990.00, total_amount: 10000, valid_months: 24, maximum_vacancies: 3, ball_amount: 20000 },
          { type: :stored, name: '49990元 储值卡', background_color: Faker::Number.hexadecimal(6), price: 49990.00, total_amount: 2000, valid_months: 36, maximum_vacancies: 5, price_per_hour: 100, price_per_ball: 0.5, minimum_charging_minutes: 20, unit_charging_minutes: 60, maximum_discard_minutes: 20 }
        ])

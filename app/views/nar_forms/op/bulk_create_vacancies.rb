class Op::BulkCreateVacancies < BaseNarForm
  attr_accessor :prefix, :suffix, :start_number, :end_number, :tags, :location, :usual_price_per_hour, :holiday_price_per_hour, :usual_price_per_bucket, :holiday_price_per_bucket
